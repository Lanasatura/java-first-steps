...
//подкласс класса TwoDShapes для представления круга
//класс Circle наследует от класса TwoDShapes
class Circle extends TwoDShapes {	
	...
	//параметризированный конструктор
	Circle(double r) {
		super(r, "circle");  //вызов конструктора суперкласса
	}
	...
	double area() {
		return Math.PI/4.0 * (getWidth() * getWidth()); //из подкласса возможно обращение к переменным суперкласса
	}
}
