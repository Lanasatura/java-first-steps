...
class GenericMethodDemo {
	//обобщённый метод определяет совпадает ли содержимое двух массивов
	...
	public static void main(String args[]) {
		...
		//аргументы типа T и V неявно определяются при вызове метода arraysEqual()
		...
		//if(arraysEqual(nums, dvals))
			//System.out.println("dvals equal nums");		
	}
}