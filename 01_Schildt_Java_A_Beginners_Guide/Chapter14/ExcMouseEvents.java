...
/*
<applet code = "ExcMouseEvents" width = 300 height = 100>
</applet >
*/

public class ExcMouseEvents extends Applet implements MouseListener, MouseMotionListener, MouseWheelListener {
	String msg = "";
	...
	//обработать событие наступающее при прокрутке колёсика мышки
