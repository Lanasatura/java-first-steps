class Block {
	...
	//возвращает true, если параметр ob определяет такой же параллелепипед
	boolean sameBlock(Block ob) {
		if((ob.a == a) & (ob.b == b) & (ob.c == c)) return true;
		else return false;
	}
	
	//возвращет true, если параметр ob определяет параллелепипед такого же объёма
